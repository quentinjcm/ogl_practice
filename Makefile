...
# Project:  ogl.pro
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug -o Makefile ogl.pro
#############################################################################
...
CXXFLAGS      = -pipe -msse -msse2 -msse3 -march=native -I/usr/local/include/SDL2 -D_REENTRANT -g -std=c++11 -Wall -W -Wno-unused-parameter -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -Iinclude -I../../../NGL/include -I/opt/qt/5.5/gcc_64/include -I/opt/qt/5.5/gcc_64/include/QtGui -I/opt/qt/5.5/gcc_64/include/QtCore -I. -I/opt/qt/5.5/gcc_64/mkspecs/linux-clang
...
COMPRESS      = gzip -9f
DISTNAME      = ogl1.0.0
DISTDIR = /home/i7624405/CA1/personal/opengl_01/obj/ogl1.0.0
LINK          = clang++
...
Makefile: ogl.pro .qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-clang/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/qt/5.5/gcc_64/mkspecs/common/unix.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/linux.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/sanitize.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-clang CONFIG+=debug -o Makefile ogl.pro
...
obj/SDL_Window.o: src/SDL_Window.cpp ../../../NGL/include/ngl/Vec2.h \
